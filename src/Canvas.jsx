...
function Canvas() {
	...
	useEffect(() => {
		...
		const canvasContainerBox = canvasContainer.getBoundingClientRect();
		console.log({ canvasContainerBox })
		canvas.width = canvasContainerBox.width;
		canvas.height = canvasContainerBox.height;

	...
	return (
		<div className="sidebar py-3">
			<div className="container mx-auto">
				...
				<div className="mb-3">
					<label for="patientDOB" className="form-label">Date of birth:</label>
				...
				<div className="row">
					<div className="col">
						<div className="mb-3">
							<label for="patientHeight" className="form-label">Height (cm.)</label>
					...
					<div className="col">
						<div className="mb-3">
							<label for="patientWeight" className="form-label">Weight (Kg.)</label>
				...
				<div className="mb-3">
					<label for="patientPhone" className="form-label">Phone</label>
